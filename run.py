...
def pip_installer():
    try:
        ...
        os.system('pip install tkinter --break-system-packages')
        os.system('pip install importlib --break-system-packages')
...
def page_two():
    ...
    if user_input2 == '12':
        os.system('python3 KittyyMap.py')
...
if user_input == '01':
    os.system('python3 catportscan.py')

if user_input == '1':
    os.system('python3 catportscan.py')

if user_input == '02':
    os.system('python3 EmalBomber.py')

if user_input == '2':
    os.system('python3 EmailBomber.py')
...
if user_input == '05':
    os.system('python3 MinecraftFindIP.py')

if user_input == '5':
    os.system('python3 MinecraftFindIP.py')

if user_input == '06':
    os.system('pyhon3 attackServer(DDOS).py')

if user_input == '6':
    os.system('python3 attackServer(DDOS).py')

if user_input == '07':
    os.system('python3 VirusBuilder.py')
